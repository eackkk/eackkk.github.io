...
![image-20200108113911848](/eackkk/img/image-20200108113911848.png)

NX enabled，randomize_va_space = 1 

![image-20200108114207740](/eackkk/img/image-20200108114207740.png)
...
![image-20200108113911849](/eackkk/img/image-20200108113911849.JPG)

但直接启动`bin/httpd`会卡在check_network()处，可以劫持lib库，重新实现这个函数，令其返回1，但这样分配到的ip会非常的奇怪.....

![image-20200113174613772](/eackkk/img/image-20200113174613772.png)
...
![image-20200108165615470](/eackkk/img/image-20200108165615470.png)
...
![image-20200108170940139](/eackkk/img/image-20200108170940139.png)
...
![image-20200112082505577](/eackkk/img/image-20200112082505577.png)

漏洞发生在initWebs()—>R7WebsSecurityHandler()中：

![image-20200108113911844](/eackkk/img/image-20200108113911844.JPG)

这些函数都是通过绑定的方式将url路径和处理函数都存储到了结构体中，然后通过`websUrlHandlerRequest()`函数根据用户的请求调用相应的处理函数：

![image-20200112101406446](/eackkk/img/image-20200112101406446.png)

其中，这个websUrlHandler是一个结构体，存放解析后的请求字段，在initwebs()中的`websUrlHandlerDefine`函数中就是通过这个结构体设置的http handler对应的处理函数：

![image-20200112103457535](/eackkk/img/image-20200112103457535.png)

在`R7WebsSecurityHandler()`函数中，从用户请求的cookie中获取到password的值，然后通过sscanf按照`%*[^=]=%[^;];*`格式拷贝到固定大小的栈缓冲区v35上![image-20200109101915172](/eackkk/img/image-20200109101915172.png)
...
![image-20200109141438341](/eackkk/img/image-20200109141438341.png)

那么如何构造能够到达这里的报文呢，我们来看下他处理url的部分：

![image-20200109151335118](/eackkk/img/image-20200109151335118.png)
...
<img src="/eackkk/img/image-20200109163402116.png" alt="image-20200109163402116" style="zoom:80%;" />

他尝从R3寄存器中存储的地址0x61616161处读取一个字节，但因为这个程序的特殊性，当用户请求中包含".gif"字段，就会直接退出这个程序

<img src="/eackkk/img/image-20200109163113601.png" alt="image-20200109163113601" style="zoom:80%;" />

<img src="/eackkk/img/image-20200109172833562.png" alt="image-20200109172833562" style="zoom:80%;" />

<img src="/eackkk/img/image-20200109181541492.png" alt="image-20200109181541492" style="zoom:80%;" />

而后会得到一个pc被覆盖为0x61616161的异常，这是因为`SUB SP, R11, #0x10`指令使得SP=R11-0x10，而此时的R11早在执行sscanf之后就被写入password的值：

<img src="/eackkk/img/image-20200109191224669.png" alt="image-20200109191224669" style="zoom:80%;" />
...
![image-20200110105148330](/eackkk/img/image-20200110105148330.png)
...
![image-20200108190513764](/eackkk/img/image-20200108190513764.png)

![image-20200108190411566](/eackkk/img/image-20200108190411566.png)
